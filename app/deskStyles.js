...
.curiosityScene>img{width:100%;height:310px;object-fit:contain;padding:20px;position:relative;z-index:2;filter:drop-shadow(0 18px 18px #17243932)}
...
.scene-ribbon>img{width:125%;max-width:none;transform:translateX(-10%);animation:ribbonUnfurl 2.8s ease-in-out infinite}
...
.scene-window>img{animation:windowOpen 2.4s ease-in-out infinite}
...
.scene-note>img{animation:noteReveal 2.4s ease-in-out infinite}
